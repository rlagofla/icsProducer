...
除 iOS 之外的系统，都可以直接打开 `ics` 文件 (比如 Windows MacOS Android)。比如安卓手机或者鸿蒙，可以直接文件传输助手把这个文件发过去，直接手机打开结束

但是苹果手机或者平板，需要稍微绕一下，可以采用以下几种方法之一：
...
添加 [ICS To Calendar](https://routinehub.co/shortcut/7005/) 到快捷指令，然后就可以直接文件传输助手传过去，分享，利用该快捷指令打开，结束
